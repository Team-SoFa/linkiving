...
export default function Landing() {
  ...
  const devLogin = () => {
    document.cookie = `${COOKIES_KEYS.AUTH_TOKEN}=dev_token; path=/; max-age=86400`;
    document.cookie = `${COOKIES_KEYS.USER_INFO}={"id":"dev","email":"dev@test.com","name":"개발자","picture":""}; path=/; max-age=86400`;
    router.push('/home');
  };
